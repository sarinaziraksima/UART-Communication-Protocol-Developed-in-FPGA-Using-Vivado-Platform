...
HD_PWD='C:/Users/Apple/Desktop/vivado/uart_tx_1/uart_tx_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_uart.tcl -notrace
