...
HD_PWD='C:/Users/Apple/Desktop/vivado/uart_tx_1/uart_tx_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_uart.tcl
